...
namespace PraktikumADO
{
    public partial class Form1 : Form
    {
        ...
        private void Koneksi()
        {
            ...
            "Data Source=GOHAMSS\\ILHAM;Initial Catalog=DBAkademikADO;Integrated Security=True"
            );
        }
        public Form1()
        {
        ...
        private void btnUpdateMK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "UPDATE Mahasiswa SET SKS = 4 WHERE KodeMK='IF210101'";
        ...
        private void btnTambahData_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Jumlah berhasil ditambahkan. Jumlah baris terpengaruh : " + hasil);
